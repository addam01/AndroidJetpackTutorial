package addam.bootstrapaac.util
...
): Observable<R> = Observable.create { subscriber ->
...
fun ObservableInt.inc(max: Int) = apply { set(java.lang.Math.min(get().inc(), max)) }
fun ObservableByte.inc(max: Byte) = apply { set(min(get().inc(), max)) }
fun ObservableChar.inc(max: Char) = apply { set(min(get().inc(), max)) }
fun ObservableLong.inc(max: Long) = apply { set(java.lang.Math.min(get().inc(), max)) }
fun ObservableShort.inc(max: Short) = apply { set(min(get().inc(), max)) }
fun ObservableFloat.inc(max: Float) = apply { set(java.lang.Math.min(get().inc(), max)) }
fun ObservableDouble.inc(max: Double) = apply { set(java.lang.Math.min(get().inc(), max)) }
...
fun ObservableInt.dec(min: Int) = apply { set(java.lang.Math.max(get().dec(), min)) }
fun ObservableByte.dec(min: Byte) = apply { set(max(get().dec(), min)) }
fun ObservableChar.dec(min: Char) = apply { set(max(get().dec(), min)) }
fun ObservableLong.dec(min: Long) = apply { set(java.lang.Math.max(get().dec(), min)) }
fun ObservableShort.dec(min: Short) = apply { set(max(get().dec(), min)) }
fun ObservableFloat.dec(min: Float) = apply { set(java.lang.Math.max(get().dec(), min)) }
fun ObservableDouble.dec(min: Double) = apply { set(java.lang.Math.max(get().dec(), min)) }
